...
<img src="./pic/logos.png" width="100"><BR>
...
|5|스피커|김태형|Trost|실시간 감정 피드백 챗봇 개발 후기(초급)|심리상담 메신저 ‘트로스트’ 업체의 머신러닝 엔지니어로 활동하면서 내담자의 감정을 분석해 실시간으로 감정 피드백을 해주는 챗봇 프로젝트를 진행하면서 느낀 생각과 후기|   
